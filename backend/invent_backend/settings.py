...
R2_DEVICE_PHOTO_PREFIX = os.environ.get("R2_DEVICE_PHOTO_PREFIX", "device-photos")
...
R2_MAX_DEVICE_PHOTO_BYTES = env_int(
    "R2_MAX_DEVICE_PHOTO_BYTES",
    R2_MAX_PROFILE_IMAGE_BYTES,
)
DATA_UPLOAD_MAX_MEMORY_SIZE = env_int(
    "DATA_UPLOAD_MAX_MEMORY_SIZE",
    max(R2_MAX_PROFILE_IMAGE_BYTES, R2_MAX_DEVICE_PHOTO_BYTES) * 3,
)
